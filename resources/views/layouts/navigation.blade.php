                ...
                @can('Admin')
                        ...
                        <li class="relative list-none">
                            <x-dropdown>
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-dropdown-link :href="route('loanPackages.index')" :class="request()->routeIs('loanPackages.index') ? 'text-red-500 font-bold' : ''">
                                        {{ __('Paket Peminjaman') }}
                                    </x-dropdown-link>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('book.index')" :active="request()->routeIs('book.index')">
                            <div class="text-[16px] font-bold tracking-wide">Book</div>
                        </x-nav-link>
                    </div>
                @endcan
            </div>
